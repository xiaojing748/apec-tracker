...
KEYWORDS = {
    ...
    "电信与网络治理": [
        ...
        "APEC telecom security",
        "APEC telecom standard",
        "APEC telecom infrastructure",
        "APEC communications security",
        "APEC 5G security",
        "APEC ICT security",
        "APEC 电信工作组",
        "APEC 电信安全",
        ...
        "APEC digital economy steering",
        "APEC 数字经济转向组",
        "APEC 数字经济指导组",
        # ECSG / 数据隐私小组
        "APEC ECSG",
        "APEC Electronic Commerce Steering Group",
        "APEC DPS data privacy",
        "APEC Data Privacy Subgroup",
        "APEC 电子商务转向组",
        "APEC 数据隐私小组",
        # ICT / 通信部长
        "APEC TELMIN",
        "APEC telecom minister",
        "APEC 电信部长",
        "APEC ICT minister",
        "APEC 通信部长",
        # 网络安全与CIIP
        "APEC CIIP",
        "APEC critical information infrastructure",
        "APEC CERT",
        "APEC CSIRT",
